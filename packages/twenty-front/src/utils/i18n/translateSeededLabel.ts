...
const SEEDED_LABEL_MESSAGES: Record<string, MessageDescriptor> = {
  ...
  'Calendar Event Participants': msg`Calendar Event Participants`,
  Contact: msg`Contact`,
  'Created by': msg`Created by`,
  'Creation date': msg`Creation date`,
  Deal: msg`Deal`,
  'Deleted at': msg`Deleted at`,
  Details: msg`Details`,
  Email: msg`Email`,
  Emails: msg`Emails`,
  Events: msg`Events`,
  ...
  'Message Participants': msg`Message Participants`,
  Name: msg`Name`,
  Note: msg`Note`,
  Notes: msg`Notes`,
  ...
  'Timeline Activities': msg`Timeline Activities`,
  Work: msg`Work`,
